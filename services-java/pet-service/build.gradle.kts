...
tasks.register("generateOpenApiServer", GenerateTask::class.java) {
    ...
    inputSpec.set("${layout.buildDirectory.get()}/docs/api-doc-service-$apiVersion/services/pet-service/openapi.yaml")
    outputDir.set(layout.buildDirectory.file("generated/sources/openapi").get().asFile.absolutePath)
    modelPackage.set("org.example.pet.web.dto")
    apiPackage.set("org.example.pet.web")
    auth.set("false")
